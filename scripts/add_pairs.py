...
def add_debate() -> List[Dict]:
    ...
    pairs.extend(generate_stepwise(df=df,
                                   label_col='year',
    ...
    pairs.extend(generate_one_v_all(df,
                                    label_col='arg_type',
    ...
    pairs.extend(generate_all_pairs(df,
                                    label_col='arg_type',
                                    name_template='debate_{label_col}_{label_pos}_{label_neg}',
                                    desc_template='are "{keyword}"',
                                    label2kw=argtype2kw.get,
...
def add_amazon_reviews() -> List[Dict]:
    ...
    distributions.update(make_distributions(
        df, text_col, label_cols=['product_category', 'stars']))
